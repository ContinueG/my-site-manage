<template>
  <div class="app-container">
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="blog.title" label="评论文章"> </el-table-column>
...
export default {
  ...
  created() {
    for (var prop of comment.data.rows) {
      prop.createDate = formatDate(prop.createDate);
    }
    this.tableData = comment.data.rows;
    this.max = comment.data.total;
  ...
  methods: {
    ...
    fetchComment() {
      getComment(this.page, this.limit).then((res) => {
